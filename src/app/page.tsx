...
export default async function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between pt-24">
      <section className="w-full text-center mt-6 h-[85dvh] relative overflow-hidden">
        <h1 className="lg:mt-16 mt-6 px-6 mx-auto font-NotoSerif font-semibold 3xl:text-6xl 2xl:text-5xl xl:text-4xl lg:text-3xl sm:text-2xl text-xl">{dataResult.value.title}</h1>
        ...
        <BooksSvg className='xl:w-full lg:w-[200%] w-[300%] absolute bottom-0 left-1/2 -translate-x-1/2' />
      </section>
